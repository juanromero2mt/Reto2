function traerInformacionCliente(){
    $.ajax({
        url:"https://g743d5bc0f07818-gastos.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
        type:"GET",
        datatype:"JSON",
...
function pintarRespuestaCliente(items){
    ...
    for(i=0;i<items.length;i++){
        ...
        mytable+="<td> <button onclick='editarCliente("+items[i].id+")'>Editar</button></td>";
