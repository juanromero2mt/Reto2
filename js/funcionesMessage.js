function traerInformacionMensaje(){
    $.ajax({
        url:"https://g743d5bc0f07818-gastos.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message",
        type:"GET",
        datatype:"JSON",
...
function pintarRespuestaMensaje(items){
    ...
    for(i=0;i<items.length;i++){
        ...
        mytable+="<td> <button onclick='editarMensaje("+items[i].id+")'>Editar</button></td>";
